...
## 🚀 作成背景
**「デバイスに物理的な振動や重りがない環境で、いかにして『身体的な疲労やしんどさ』という感触体験をユーザーに届けるか」** という問いから作成しました。

一般的なゲームでは、キャラクターの能力低下は単なる数値やゲージで処理されがちです。本作では、ユーザーの入力（キーを押し続ける力）に対するキャラクターの応答速度や歩行動作の質を意図的に低下させることで、ユーザー自身の脳内に「指が重い」「もどかしい」という物理的な錯覚を誘発させ、デジタル空間における身体的体験の共有を目指しました。
